...
-(NSString *)getJsonStringByTooldsByKeys:(NSArray *)keys{
    ...
    NSDictionary *dict1 = [EntityConvertUtils entityConvertToDict:_callCacheEntity];
...
//        _callCacheEntity = [_libInitInfo initByJsonDict:mulDict];
        [EntityConvertUtils initByJsonDict:mulDict obj:_callCacheEntity];
    }
}
