...
-(void)createItemsView{
    ...
    if(!_fieldContent){
        ...
        _fieldContent.textColor = SobotColorFromRGB(0x333333);
        _fieldContent.layer.borderColor = SobotColorFromRGB(0xEDEEF0).CGColor;
    ...
    if(!_textContent){
        ...
        _textContent.textColor = SobotColorFromRGB(0x333333);
        _textContent.layer.borderColor = SobotColorFromRGB(0xEDEEF0).CGColor;
...
//        _labTitle.text = [NSString stringWithFormat:@"%@ %@",item[@"code"],item[@"name"]];
        ...
        if([key isEqual:@"loginPassword"]){
            _fieldContent.secureTextEntry = YES;
        }else{
            _fieldContent.secureTextEntry = NO;
        }
